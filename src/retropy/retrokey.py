class RetroKey:
    # Constants below correspond to libretro constants of the same name with prefix "RETRO_DEVICE_ID_" added
    # E.g. value of constant "JOYPAD_B" below is equal to value of "RETRO_DEVICE_ID_JOYPAD_B" constant in libretro
    JOYPAD_B = 0
    JOYPAD_Y = 1
    JOYPAD_SELECT = 2
    JOYPAD_START = 3
    ...
    # Constants below correspond to libretro constants of the same name
    RETROK_BACKSPACE = 8
    RETROK_TAB = 9
    RETROK_CLEAR = 12
    RETROK_RETURN = 13
